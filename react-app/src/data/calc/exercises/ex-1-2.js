...
export default {
  ...
  problems: [
    ...
    },
    {
      ...
      steps: [
        { text: "**(a)–(c) Prices from demand** (q in hundreds): a) q=0 → p=$16;  b) 400 watches, q=4 → 16−1.25(4)=$11;  c) 800 watches, q=8 → 16−1.25(8)=$6." },
        { text: "**(d)–(f) Quantities from demand** (solve for q): d) 8=16−1.25q → q=6.4 → 640;  e) 10=16−1.25q → q=4.8 → 480;  f) 12=16−1.25q → q=3.2 → 320 watches." },
        { text: "**(h)–(j) Quantities from supply** q = p⁄0.75: h) $0 → 0;  i) $10 → q≈13.33 → ≈1333;  j) $20 → q≈26.67 → ≈2667 watches." },
        { text: "**(l) Equilibrium** — set supply = demand:" },
    ...
    },
    {
      ...
      steps: [
        { text: "(a) Two points (100, 11.02) and (400, 40.12). Slope:" },
        { tex: "m = \\frac{40.12 - 11.02}{400 - 100} = \\frac{29.10}{300} = 0.097" },
        { tex: "11.02 = 0.097(100) + b \\;\\Rightarrow\\; b = 1.32 \\;\\Rightarrow\\; C(x) = 0.097x + 1.32" },
        { text: "(b) Fixed cost = constant term = **$1.32**." },
        { tex: "(c)\\ C(1000) = 0.097(1000) + 1.32 = 98.32" },
        { tex: "(d)\\ C(1001) = 0.097(1001) + 1.32 \\approx 98.42" },
        { text: "(e) Marginal cost of the 1001st cup = C(1001) − C(1000) = **$0.097 ≈ 10¢**. (f) For a linear cost the marginal cost of *any* cup is the slope, **$0.097** — every extra cup costs about 9.7¢ to make." },
      ],
