  ...
  problems: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "(b) Vertical asymptote x = −475 (outside the domain x > 0); horizontal asymptote y = 0." },
        { text: "(c) No x-intercept (the numerator is a nonzero constant), and no y-intercept since x > 0." },
        { text: "(d) The cost per ton falls from about $463/ton near x = 0 toward 0 as tankers grow larger." },
      ],
